...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignfull">
			...
			<div class="wp-block-group">
				<!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
					<!-- wp:navigation-link {"label":"首页","url":"/"} /-->

					<!-- wp:navigation-link {"label":"关于我们","url":"/about-us"} /-->

					<!-- wp:navigation-link {"label":"产品中心","url":"/products"} /-->
				<!-- /wp:navigation -->

				<!-- wp:navigation {"overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"}} -->
					<!-- wp:navigation-link {"label":"新闻中心","url":"/news"} /-->

					<!-- wp:navigation-link {"label":"常见问题","url":"/faq"} /-->

					<!-- wp:navigation-link {"label":"联系我们","url":"/contact-us"} /-->
				<!-- /wp:navigation -->
			</div>
				<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-group alignfull">
			...
			<p class="has-small-font-size">© 2026 常州市创联电源科技股份有限公司 版权所有</p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size">
				<a href="https://beian.miit.gov.cn/" target="_blank" rel="nofollow">苏ICP备1331515号-1</a>
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
